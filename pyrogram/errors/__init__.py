...
from .exceptions import *  # noqa: F403 - generated by `make api`, absent from a fresh checkout
from .rpc_error import UnknownError  # noqa: F401 - re-exported as `pyrogram.errors.UnknownError`
